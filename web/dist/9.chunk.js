...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__goal_create_component__ = __webpack_require__(1162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__goal_create_routing__ = __webpack_require__(1176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_material__ = __webpack_require__(79);
...
var GoalCreateComponent = (function () {
    function GoalCreateComponent(router, route, renderer, broadcaster, _projectService, _cacheService) {
        ...
        router.events.subscribe(function (val) {
            if (_this.eventId != val.id && val instanceof __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* NavigationEnd */]) {
                _this.eventId = val.id;
                _this.id = _this.route.snapshot.params['id'];
                _this.slug = _this.route.snapshot.params['status'];
                _this.isPrivate = (_this.slug && _this.slug != 'draft');
                if (_this.id) {
    ...
    GoalCreateComponent.prototype.removeImage = function (id) {
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__goal_create_component__ = __webpack_require__(1162);
