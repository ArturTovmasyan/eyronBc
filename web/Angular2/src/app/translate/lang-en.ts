...
export const LANG_EN_TRANS = {
    ...
    "facebook_post_text": "I have completed another goal on Bucket List 127. This is how dreams turn into memories! It’s time to take on some more.",
    "goal": {
    ...
    "filters": {
    "import_urgent": "Important, <br />\n<span>urgent<span/>\n",
        "not_import_urgent": "Not important, <br />\n<span>urgent<span/>\n",
        "import_not_urgent": "Important, <br />\n <span> not urgent<span/>\n",
        "not_import_not_urgent": "Not important, <br />\n<span>not urgent<span/>\n"
},
    "account": {
    ...
    "title": "Bucket List 127-My Bucketlist",
        ...
        "complete": "It’s time to act and complete",
    ...
    "mobile_modal": "Bucket List 127 is available everywhere!\nDownload the app, discover great features and explore over thousand exciting ideas for your goals.\n",
    "home_listed_by": "Listed by",
    "listed_by": "Listed",
    "block_listed": "Listed",
    "block_completed": "Completed",
    "Add an email": "Add an email",
    "social_post_text": "I just started my Bucket List: so far the best tool to make sure I have memories, not just dream;) Join Bucket List 127, it's amazing!\n",
    "forget": "Remove",
    ...
    "upload": "An image must have minimum dimensions 800x600px with recommended dimensions of 1280x720px. <br />\n The maximum size of an image must not exceed 4MB.\n",
    "delete_message": "You are about to remove your goal. <br />\nAre you sure?\n",
