...
class UserGoalAdmin extends AbstractAdmin
{
    ...
    protected function configureShowFields(ShowMapper $showMapper)
    {
        $showMapper
            ...
            ->add('status', null, ['label'=>'admin.label.name.status'])
            ...
            ->add('steps', null, ['label'=>'goal.steps'])
            ->add('confirmed', null, ['label'=>'admin.label.name.confirmed'])
            ->add('goal.id', null, ['label'=>'admin.label.name.goal'])
...
//            ->add('goal.id', null, ['label'=>'admin.label.name.goal'])
            ->add('user', null, ['label'=>'admin.label.name.user'])
//            ->add('user', 'sonata_type_model_autocomplete', ['label'=>'admin.label.name.user', 'property'=>'username', 'multiple' => true, 'required' => false])
    ...
    protected function configureDatagridFilters(DatagridMapper $datagridMapper)
    {
        $datagridMapper
            ...
            ->add('listedDate', 'doctrine_orm_date_range', ['label' => 'admin.label.name.created', 'show_filter' => true], 'sonata_type_date_range_picker',
                [
                    'field_options_start'=> ['format'=>'yyyy-MM-dd'],
                    'field_options_end'=> ['format'=>'yyyy-MM-dd']
                ]
