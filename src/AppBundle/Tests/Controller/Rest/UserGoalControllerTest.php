...
class UserGoalControllerTest extends BaseClass
{
    ...
    public function testPut()
    {
        ...
        if ($profile = $this->client->getProfile()) {
            // check the number of requests
            $this->assertLessThan(12, $profile->getCollector('db')->getQueryCount(), "number of requests are much more greater than needed on user-goal create rest!");
        }
    }
    ...
    public function testPostBucketlist()
    {
        ...
        if ($profile = $this->client->getProfile()) {
            // check the number of requests
            $this->assertLessThan(9, $profile->getCollector('db')->getQueryCount(), "number of requests are much more greater than needed on  user-goal postBucketlistAction rest!");
        }
    ...
    public function testDelete($userGoalId)
    {
        ...
        if ($profile = $this->client4->getProfile()) {
            // check the number of requests
            $this->assertLessThan(9, $profile->getCollector('db')->getQueryCount(), "number of requests are much more greater than needed on delete user-goal rest!");
        }
    }
    ...
    public function testPostBucketlistLocation()
    {
        ...
        if ($profile = $this->client->getProfile()) {
            // check the number of requests
            $this->assertLessThan(9, $profile->getCollector('db')->getQueryCount(), "number of requests are much more greater than needed on  user-goal postBucketlistLocationAction rest!");
        }
    ...
    public function testGetUserGoalInfo()
    {
        ...
        if ($profile = $this->client2->getProfile()) {
            // check the number of requests
            $this->assertLessThan(10, $profile->getCollector('db')->getQueryCount(), "number of requests are much more greater than needed on testGetUserGoalInfo rest!");
        }
